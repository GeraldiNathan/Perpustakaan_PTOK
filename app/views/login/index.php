...
<div class="py-[140px]">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div class="w-full p-8 lg:w-1/2">
            <h2 class="text-2xl font-semibold text-gray-700 text-center"><a href="<?= BASEURL ?>">PT OTAK KANAN</a></h2>
            ...
            <form action="<?= BASEURL ?>/login/signIn" method="post">
                <div class="mt-4">
                    ...
                    <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" name="username" required />
                </div>
                <div class="mt-4">
